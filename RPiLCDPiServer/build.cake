...
var framework = Argument("framework", "netcoreapp3.0");
...
var destinationIp = Argument("destinationPi", "192.168.0.10");
var destinationDirectory = Argument("destinationDirectory", @"/home/pi/LCDStatsApp");
var destinationAssetsDirectory = Argument("destinationDirectory", @"/home/pi/LCDStatsApp/Assets/UIImages");
var username = Argument("username", "pi");
var sessionname = Argument("sessionname", "Pi");
var executableName = Argument("executableName", "RPiLCDPiServer");
...
Task("Deploy")
    ...
    .Does(() =>
    {
        ...
        var assets= GetFiles("./publish/Assets/UIImages/*");
        ...
        {
            var destination = destinationIp + ":" + destinationDirectory;
            var destinationAssets = destinationIp + ":" + destinationAssetsDirectory;
            var fileArray = files.Select(m => @"""" + m.ToString() + @"""").ToArray();
            var assetArray = assets.Select(m => @"""" + m.ToString() + @"""").ToArray();
            ...
            Pscp(assetArray, destinationAssets, new PscpSettings
                                            { 
                                                SshVersion = SshVersion.V2,
                                                User = username 
                                            }
...
Task("DeployWithPuTTYSession")
    ...
    .Does(() =>
    {
        ...
        Pscp(assetArray, destination, new PscpSettings
                                            { 
                                                SshVersion = SshVersion.V2 
                                            }
        );
